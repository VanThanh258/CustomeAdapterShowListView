...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Map();
        arrayList.add(new Baihat("Người như anh", "Mai Tiến Dũng", (float)4.13));
        arrayList.add(new Baihat("Vũ điệu gió", "Ngọc Mai", (float)3.12));
        arrayList.add(new Baihat("Giữa Ngân Hà", "lady Mây", (float)4.1));
